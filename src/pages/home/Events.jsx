...
const Events = ({ inPage }) => {
    return (
        <section className={`${inPage ? "py-0" : "py-8 lg:py-16"}  bg-violet-100`}>
            <div className="flex flex-col items-center justify-between p-6 overflow-hidden bg-white rounded-md shadow-md sm:p-8 md:p-12 sm:flex-row wrapper">
                <div className="sm:w-[40%] md:w-[45%] lg:w-[40%] xl:w-[35%] w-[50%]">
                    <img
                ...
                <div className="flex flex-col md:w-[50%] sm:w-[60%] sm:gap-3 gap-2 w-full">
                    ...
                    <p className="hidden lg:line-clamp-4 xl:line-clamp-6">
