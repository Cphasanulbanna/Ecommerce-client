...
const LoginShop = () => {
    ...
    return (
        <FormLayout>
            <div className="flex flex-col justify-center w-full h-screen gap-4 p-6 font-semibold bg-white rounded-none shadow-sm sm:h-max sm:max-w-md sm:mx-auto sm:gap-8 sm:p-12 sm:rounded-lg">
