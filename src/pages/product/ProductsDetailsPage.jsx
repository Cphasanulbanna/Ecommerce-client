    ...
    const MoreDetails = ({ product }) => {
        return (
            <div className="wrapper rounded-sm bg-slate-50  min-h-[40vh] shadow-sm mb-10">
                <div className="md:flex hidden items-center justify-between px-5 pt-5 pb-2 border-b-[1px] border-solid border-slate-200">
                    <h5
                        ...
                        } text-base sm:text-xl font-bold text-black cursor-pointer`}
                    >
                        Product Details
                    </h5>
                    <h5
                ...
                <div className="flex flex-col gap-8 md:hidden">
                    <div className="flex p-5 flex-col gap-3 md:gap-6 relative after:-bottom-4 after:left-0 after:right-0 after:h-[2px] after:absolute after:border-slate-500 after:border-b-[1px] after:border-solid]">
                        <h5 className={`text-base sm:text-xl font-bold text-black cursor-pointer`}>
                            Product Details
                        </h5>
                        <p>
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptas
                            blanditiis assumenda laudantium provident odit sed eius fugit error
                            earum quam quae veritatis, adipisci similique amet nisi consequatur
                            delectus dolorum ut sunt accusantium ipsum reprehenderit. Aut vel ipsa,
                            excepturi, quaerat vitae quia hic quos sit maxime nostrum dignissimos,
                            amet fugit. Quis!
                        </p>
                        <p>
                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Recusandae
                            perferendis omnis ratione repellendus, ipsa aliquam iusto incidunt quasi
                            aspernatur molestiae, sed doloribus error magni. Eaque blanditiis nemo
                            deserunt expedita eligendi eveniet inventore quam earum quo, doloribus
                            obcaecati exercitationem, eos possimus minima impedit nihil totam
                            delectus ex, laborum corporis culpa assumenda cumque praesentium
                            accusantium. Fugiat ea, ab magnam magni eum blanditiis.
                        </p>
                        <p>
                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Magnam velit
                            ipsum eligendi optio ea fugiat expedita dolores illo quam quo,
                            exercitationem placeat, delectus dignissimos rerum!
                        </p>
                    </div>

                    <div className="p-5 relative after:-bottom-4 after:left-0 after:right-0 after:h-[2px] after:absolute after:border-slate-500 after:border-b-[1px] after:border-solid]">
                        <h5 className={`text-base sm:text-xl font-bold text-black cursor-pointer`}>
                            Product Reviews
                        </h5>
                        <p>No reviews</p>
                    ...
                    <div className="p-5">
                        <h5 className="flex-col mb-3 text-base font-bold text-black cursor-pointer md:mb-6 md:flex-row sm:text-xl">
                            Seller Information
                        </h5>
                        <div className="flex flex-col justify-between gap-4 md:flex-row">
                            <div className="md:w-[65%] flex flex-col gap-4 w-full">
                                <div className="flex items-center gap-4">
                                    <div className="w-[40px] h-[40px] cursor-pointer rounded-full overflow-hidden">
                                        <img
                                            src={product?.shop?.shop_avatar.url}
        ...
        <>
            ...
            >
                <div className=" sm:wrapper">
                    <div className="flex flex-col justify-between gap-5 p-5 bg-white rounded-md sm:p-10 md:flex-row">
                        ...
                        <div className="flex flex-col gap-3 w-full md:w-[45%] xl:w-[35%]">
                            ...
                            <div className="fixed bottom-0 left-0 right-0 z-50 flex justify-between sm:gap-2 md:flex-col lg:flex-row sm:static">
                                <button className="text-white bg-[#fb641b] btn min-h-[42px] h-[40px] w-1/2 border-none rounded-none md:w-full lg:w-[48%] sm:w-[48%]">
                                    <span>Add to cart</span>
                                    <FaCartPlus size={16} />
                                </button>
                                <button className="text-white bg-[#ff9f0e] btn min-h-[42px] h-[40px] w-1/2 border-none rounded-none md:w-full lg:w-[48%] sm:w-[48%]">
                                    <span>Buy now</span>
                                    <IoMdFlash size={16} />
                                </button>
                            </div>
